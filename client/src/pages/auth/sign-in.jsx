...
const triggerAlert = () => {
  ...
  const handleLogin = async (e) => {
    e.preventDefault();
    var ress = await login(email, password);
   
   //return data;
   if(ress == "incorrect"){
     // alert("incorrect");
      setAlertvalue('Your credentials are invalid' );
      ...
      setAlertvalue('Login Succeccful' );
        ...
        {showAlert  && 
         ...
         { /*<div className="flex items-center justify-between gap-2 mt-6">
          ...
          <div className="space-y-4 mt-8">
            <Button onClick={handleGoogleLogin} size="lg" color="white" className="flex items-center gap-2 justify-center shadow-md" fullWidth>
